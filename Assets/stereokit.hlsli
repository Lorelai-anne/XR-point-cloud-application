...
finger_dist_t FingerDistanceInfo(float3 world_pos, float3 world_norm)
{
    return sk_finger_distance_info(world_pos, world_norm);
}
...
{
    return sk_finger_glow_ex(world_pos, world_norm);
}
...
{
    return sk_finger_glow(world_pos, world_norm);
}
